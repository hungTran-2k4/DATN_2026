...
namespace DATN.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary>The AssignedAt property of the Entity UserRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "user_roles"."assigned_at".<br/>Table field type characteristics (type, precision, scale, length): Timestamp, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime AssignedAt
		{
			get { return (System.DateTime)GetValue((int)UserRoleFieldIndex.AssignedAt, true); }
			set { SetValue((int)UserRoleFieldIndex.AssignedAt, value); }
		}
